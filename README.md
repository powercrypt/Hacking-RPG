...
Roll 1d6 once for each hacking attribute, you can reroll your character but you have to reroll every hacking attribute if you do.

When you start a scenario you have all of the relavent points available to you.  

The game masters job is to assign a difficulty score for the scenario which depends on the type of server.  

Roll two dice to begin, yes just like street craps. You get to decide which attribute you are using.

You score a point on the system if you roll 7 or 11. 

If a 2, 12, or 3 come up you lose that round. 

If you lose erase one of your points in the attribute you used.

If you roll another number that becomes your point number.  
...
At this point you lose a point in paranoia, but can still try again.  
...
When you run you have as many chances to roll your escape as your run score. But your run score never recharges.
...
On your next mission your main hacker attributes go up to their normal levels.
